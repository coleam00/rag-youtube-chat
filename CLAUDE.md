...
4. **Chat completion** uses OpenRouter's `moonshotai/kimi-k2.6` via the `openai` SDK pointed at `https://openrouter.ai/api/v1`. Do not change the provider or the model in a PR — that's out of scope per MISSION.md.
